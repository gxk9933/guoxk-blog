<?php if(date('Y-m-d') == '2012-10-26'){ //Go Dark For IE活动 ?>
<!--[if lt IE 9]>
<div style="top:0;left:0;right:0;bottom:0;background:black url('sites/all/themes/corporateclean/images/dark-ie.jpg') top center no-repeat;z-index:999999999;text-align:center;">
	<a href="http://godarkforie.org/upgrade"><div class="container" style="padding:80px 0;padding-top:240px;width:960px;margin:0 auto;">
		<h1 style="font-weight: 300;line-height: 100%;font-size: 100px;color: #fff;margin: 0 0 40px 0;">
		Go Dark For IE</h1>
		<h2 style="font-size:28px;line-height:1.4em;">
		The website you have come from has taken part in the Go Dark For IE campaign 
		which aims to raise awareness of the implications of using older browsers 
		and how it is hurting the web.</h2>
	</div></a>
</div>
<![endif]-->
<?php }?>
